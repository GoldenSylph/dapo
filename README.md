...
Предлагаемая система DAO должна строго отражать организационную структуру и порядок принятия решений, которые строго соответствуют Уставу партии «Рассвет» и его духу. Поэтому все изменения матрицы мнения $\mathcal{M}$ допускаются **только через голосование**, и только тем органом, который уполномочен на основании уставного кодирования строки ячейки.
