...
3) Для бэкенд части (cерверной):
   ...
   4) Для генерации человекочитаемой рекомендации ДАПО: любой шаблонизатор на языке Python.
4) Для базы данных шаблонов рекомендаций: публичная GitHub организация под рабочим названием ДАПО Шаблоны. 
